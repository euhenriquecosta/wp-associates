...
/**
 * Classe para gerenciar os municípios da Bahia
 *
 * @package Associates
 * @since 1.0.0
 */
...
class Municipalities {
    ...
    /**
     * Lista de municípios da Bahia com coordenadas
     */
     ...
     */
    private function init_municipalities() {
    ...
    /**
     * Retorna as coordenadas de um município específico
     */
    public function get_municipality_coordinates($municipality_name) {
        if (isset($this->municipalities[$municipality_name])) {
            return $this->municipalities[$municipality_name];
        }
        return null;
    }
    
    /**
     * Retorna todos os nomes dos municípios
     */
    public function get_municipality_names() {
        return array_keys($this->municipalities);
    }
    
    /**
     * Verifica se um município existe
     */
    public function municipality_exists($municipality_name) {
        return isset($this->municipalities[$municipality_name]);
    }
}
